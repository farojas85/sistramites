...
<div class="modal fade" id="M_Crear" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <select class="form-control text-uppercase" style="height: calc(2.1em + .18rem + 2px);" id="tr_tipo" placeholder="" pattern="[A-Za-z ].{1,}" title="Ingrese solo letras" required>
           ...
           <SELECT  id="tipod" style="height: calc(2.1em + .15rem + 2px);" class="form-control text-uppercase"  required>
                         <?php       
                        //    $idxx=1;
  ...
  ?>
          ...
          <lavel class="form-group col-xs-12 col-md-12 col-lg-12" style="color:red; height: calc(0.1em + .14rem + 2px);">TUPA</lavel>   
                ...
                <label>Proceso Administrativo:</label>
                        <SELECT  id="tupa" style="height: calc(2.1em + .14rem + 2px);" class="form-control text-uppercase"  required>
                            <option value="5">NINGUNO</option>  
                         <!-- <?php       
                            //     $idt=1;
                            //   $Validart= mysqli_prepare($con, "SELECT t.tup_id,t.tup_nombre FROM tupa as t, tupas_act as tu where t.tup_estatus=tu.tua_id and tu.tua_estatus='ACTIVO' AND  t.tup_id  not in(5)");
                            //             mysqli_stmt_bind_param($Validart);
  ...
  ?> -->
              ...
              <div class="form-group col-xs-12 col-md-12 col-lg-4">
                ...
                <select class="form-control text-uppercase" style="height: calc(2.1em + .18rem + 2px);" id="silencio" placeholder="" pattern="[A-Za-z ].{1,}" title="Ingrese solo letras" required>
             ...
             <lavel class="form-group col-xs-12 col-md-12 col-lg-12" style="color:red; height: calc(0.1em + .14rem + 2px);">DERIVACION</lavel>  
                                ...
                                <div class="form-group col-xs-12 col-md-12 col-lg-4">
                <label>Unidad:</label>
            <SELECT  id="unidad" style="height: calc(2.1em  + .14rem + 2px);" class="form-control text-uppercase"  required>
                             <option value="3">NINGUNO</option>                
                         <!-- <?php       
                        //    $idx=1;
                        //       $Validar= mysqli_prepare($con, "SELECT dep_id,dep_nombre FROM departamento where dep_id>=? and dep_id  not in(3)");
  ...
  ?> -->
                ...
                <input class="form-control text-uppercase" style="height: calc(1.9em + .14rem + 2px);" id="proveido" type="text" placeholder=""  value="- 0 -" required>
              </div>
                                <div class="form-group col-xs-12 col-md-12 col-lg-4">
                <label>Tipo:</label>
                        <select class="form-control text-uppercase" style="height: calc(2.1em + .18rem + 2px);" id="tipoEstatus" placeholder="" pattern="[A-Za-z ].{1,}" title="Ingrese solo letras" required>
